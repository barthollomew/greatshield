import { ErrorHandler, ErrorCategory, ErrorSeverity, StructuredError } from '../../bot/src/utils/ErrorHandler';
...
describe('ErrorHandler', () => {
  ...
  describe('Error Queries', () => {
    ...
    it('should filter errors by category', () => {
      ...
      expect(dbErrors.every((e: any) => e.category === ErrorCategory.DATABASE)).toBe(true);
    });
